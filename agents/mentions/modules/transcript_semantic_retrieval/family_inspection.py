...
def inspect_family(family: str, speaker: str = 'Donald Trump', transcript_limit: int = 8, top_k: int = 2) -> dict:
    from agents.mentions.modules.transcript_semantic_retrieval.prototype import semantic_segment_search
    from agents.mentions.modules.transcript_semantic_retrieval.corpus_discovery import sample_segments
