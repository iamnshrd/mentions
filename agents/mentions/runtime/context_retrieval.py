...
from agents.mentions.runtime.retrieval_fallbacks import empty_news_context, empty_transcript_context
...
def retrieve_market_context(query: str) -> dict:
    ...
    from agents.mentions.modules.url_intake import intake_market_input, recover_canonical_ticker
    ...
    bundle = {}
    try:
        from agents.mentions.modules.market_data import build_market_data_bundle
...
def retrieve_transcript_context(frame: dict) -> dict:
    ...
    try:
        from agents.mentions.modules.transcript_intelligence import build_transcript_intelligence_bundle
