...
Runs a gold-standard query set (``agents/mentions/assets/eval_queries.json``) through
...
from agents.mentions.config import EVAL_QUERIES, EVAL_REPORT
from mentions_domain.intent import classify_intent
from mentions_domain.llm import LLMClient, NullClient
from agents.mentions.utils import now_iso, load_json

log = logging.getLogger('mentions')


GOLD_QUERIES_PATH = EVAL_QUERIES
...
def _profit_sim(rows: list[dict], *, fractional: float = 0.25,
    ...
    :func:`mentions_domain.posteriors.probability.kelly_fraction`; payoff
    ...
    """
    from mentions_domain.posteriors.probability import kelly_fraction
