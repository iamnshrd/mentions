...
"""Shared shape helpers for extracted Mentions modules.

These helpers are intentionally lightweight. They do not replace the richer
protocols in `contracts.py`, but give extracted modules a common normalized
bundle shape and reduce ad hoc dict drift across runtime paths.
"""
