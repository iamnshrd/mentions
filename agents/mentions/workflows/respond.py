"""Canonical workflow entrypoint for response composition."""
...
from agents.mentions.workflows.retrieve import retrieve_bundle_for_frame
from agents.mentions.workflows.synthesize import synthesize as do_synthesize
