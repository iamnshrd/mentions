...
from library.utils import now_iso, get_threshold, save_json
from library.config import DASHBOARD, DASHBOARD_LATEST
...
def _fetch_top_movers(limit: int) -> list[dict]:
    ...
    try:
        from library._core.fetch.kalshi import get_top_movers
