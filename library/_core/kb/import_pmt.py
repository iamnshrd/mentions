"""Import structured knowledge from the historical PMT architecture dump.

Source schema: pmt-architecture-dump/pmt_trader_knowledge.db
Target schema: library/mentions_data.db (v2+)
...
Usage::
    ...
    report = import_pmt(src_path='pmt-architecture-dump/pmt_trader_knowledge.db')
