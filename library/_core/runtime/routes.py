"""Canonical route registry — single source of truth for market route names and keywords.

Every module that needs to classify queries by analysis type should import from here
