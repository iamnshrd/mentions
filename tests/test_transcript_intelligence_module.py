...
from agents.mentions.modules.transcript_intelligence.builder import build_transcript_intelligence_bundle


def test_transcript_intelligence_empty(monkeypatch):
    monkeypatch.setattr(
        'agents.mentions.modules.transcript_intelligence.builder.search_transcripts',
...
def test_transcript_intelligence_infers_speaker_and_summarizes(monkeypatch):
    ...
    monkeypatch.setattr(
        'agents.mentions.modules.transcript_intelligence.builder.search_transcripts_runtime',
        lambda query='', speaker='', limit=10: [],
    )
    monkeypatch.setattr(
        'agents.mentions.modules.transcript_intelligence.builder.search_transcript_tags_runtime',
