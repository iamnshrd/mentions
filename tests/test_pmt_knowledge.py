from agents.mentions.services.knowledge.pmt import query_pmt_knowledge_bundle


def test_pmt_knowledge_returns_bundle_from_active_db():
    bundle = query_pmt_knowledge_bundle(
        event_title='Trump interview',
        speaker='Trump',
        fmt='interview',
        freeform='Iran mention market',
        top=2,
    )
